...
ALTER TABLE Users
  ADD COLUMN IF NOT EXISTS role_id TINYINT UNSIGNED NULL,
...
ALTER TABLE Products
  ADD COLUMN IF NOT EXISTS unit_label ENUM('Dharni','Muri','Kilo','Packet','Boras','Unit') NOT NULL DEFAULT 'Unit',
...
ALTER TABLE Expenses
  ...
  ADD COLUMN IF NOT EXISTS reference_no VARCHAR(80) NULL,
  ADD COLUMN IF NOT EXISTS vendor_name VARCHAR(120) NULL,
